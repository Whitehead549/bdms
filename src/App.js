  ...
  return (
    <div className="bg-[#000300] overflow-x-hidden relative">
      ...
      <a
        ...
        className="fixed bottom-6 right-6 bg-pink-500 hover:bg-pink-700 text-white p-3 rounded-full shadow-lg transition duration-300 ease-in-out z-50 pointer-events-auto flex items-center space-x-2"
      >
